...
#define INPUT_FILE "data/sonic1.wav" /* Ajuste o caminho para apontar para o arquivo correto! */
#define OUTPUT_FILE "data/teste0_basico.wav" /* Ajuste o caminho para apontar para o arquivo correto! */
