...
#define BASE_TEMPO 11605 /* N�mero de amostras em 1/2 batida a 114 bpm. */
#define N_BEATS 32
...
int main ()
{
    ...
    // Cria a m�sica a partir de ondas quadradas.
    ptr_l = dados_l;
    ptr_r = dados_r;
...
void geraSenoide(double* dados, int n_amostras, int taxa, double freq, double fase) {
	...
	// pior q foi relativamente facil depois de encontrar a formula
}
